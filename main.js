...
const habilidadesMap = [
    { key: 'hasDash', label: 'Dash (Mothwing Cloak)' },
    { key: 'hasWalljump', label: 'Pulo na Parede (Mantis Claw)' },
    { key: 'hasDoubleJump', label: 'Pulo Duplo (Monarch Wings)' },
    { key: 'hasSuperDash', label: 'Super Dash (Crystal Heart)' },
    { key: 'hasShadowDash', label: 'Dash Sombrio (Shade Cloak)' },
    { key: 'hasAcidArmour', label: 'Resistência a Ácido (Isma\'s Tear)' },
    { key: 'hasDreamNail', label: 'Ferrão dos Sonhos (Dream Nail)' },
    { key: 'hasSpell1', label: 'Magia 1 (Vengeful Spirit)' },
    { key: 'hasAllNailArts', label: 'Todas Artes do Ferrão' }
];
...
function initAdvancedUI() {
    ...
    // 2. Gerar Amuletos (Lidando com as exclusividades de Lore)
